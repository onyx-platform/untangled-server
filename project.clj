(defproject navis/untangled-server "0.7.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.9.0-alpha13" :scope "provided"]
                 ...
                 [commons-codec "1.10"] ; hard recursive dep resolution
                 [com.h2database/h2 "1.4.191" :scope "test"]
                 [org.clojure/java.jdbc "0.7.0-alpha1" :scope "test"]
                 ...
                 [com.datomic/datomic-free "0.9.5544" :scope "test" :exclusions [joda-time]] ]
